...
typedef enum  { nmea_id_unknown=0, nmea_id_HEA, nmea_id_ORI, nmea_id_DEP, nmea_id_POS, nmea_id_GGA, nmea_id_HDT} nmea_sentence_id_e; 
...
int nmea_nav_process_nav_packet(char* databuffer, uint32_t len, double forec_ts, double* ts_out, double z_offset, uint16_t alt_mode, PJ *proj, navdata_t *navdata, aux_navdata_t *aux_navdata);
